...
def extract_conv_gain(optimization_input_parameters,Vinp='G1',Vinn='G2',Voutp='Voutp',Voutn='Voutn'):
	...
	for i in range(len(gain)):
		if abs(gain[i])<abs(gain[i])/np.sqrt(2):
	...
	bb_BW=threedb_freq-freq_out_list[0]
	extracted_parameters['bb_BW']=bb_BW

...
def calc_loss_1(extracted_parameters,output_conditions,loss_weights):
	...
	loss_iip2=A3*ramp_func(iip3_ref-iip2)
	loss_nf=A4*ramp_func(nf-nf_ref)
	loss_Io=A5*Io
	
	loss=loss_gain+loss_iip3+loss_iip2+loss_nf+loss_Io
	loss_dict={'loss':loss,'loss_gain':loss_gain,'loss_iip3':loss_iip3,'loss_iip2':loss_iip2,'loss_nf':loss_nf,'loss_Io':loss_Io}

...
#-----------------------------------------------------------------------------------------------------
# This function will be used to analyze the temperature variaition for the best optimized result
def temperature_process_variation_single_run(optimization_results,optimization_input_parameters):
	
	print("-------------------------------------------------------------Temperature , Process Variation of Best Result -----------------------------------------------------------------------")
	circuit_parameters=optimization_input_parameters['manual_circuit_parameters']
	print("Circuit Parameters : ", circuit_parameters)

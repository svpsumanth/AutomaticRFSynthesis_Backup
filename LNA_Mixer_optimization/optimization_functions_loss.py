...
def calc_loss_1(extracted_parameters,output_conditions,loss_weights):
	...
	Io=extracted_parameters['Io1']+extracted_parameters['Io2']
	...
	loss_s11=A7*ramp_func(s11-s11_ref)
	#loss_region=A7*(region-2)**2
	#loss=loss_gain+loss_iip3+loss_iip2+loss_nf+loss_Io+loss_BW+loss_region
	loss=loss_gain+loss_iip3+loss_nf+loss_Io+loss_BW+loss_s11
	#print(loss,loss_gain,loss_nf,loss_s11)
	loss_dict={'loss':loss,'loss_gain':loss_gain,'loss_iip3':loss_iip3,'loss_iip2':0,'loss_nf':loss_nf,'loss_Io':loss_Io,'loss_BW':loss_BW,'loss_s11':loss_s11,'loss_region':0}

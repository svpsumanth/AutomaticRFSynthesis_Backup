...
def print_extracted_outputs(extracted_parameters):
	...
	print ('s12_db   = ',num_trunc(extracted_parameters['s12_db'],trunc_val))
	print ('s21_db   = ',num_trunc(extracted_parameters['s21_db'],trunc_val))
	print ('s22_db   = ',num_trunc(extracted_parameters['s22_db'],trunc_val))
	print ('Kf       = ',num_trunc(extracted_parameters['Kf'],trunc_val))

...
def temperature_variation_final(best_circuit_parameters,optimization_input_parameters):
	
	print("-------------------------------Temperature Variation of Best Result --------------------------------------------")
	circuit_parameters=best_circuit_parameters
...
#-----------------------------------------------------------------------------------------------------
# This function will be used to analyze the temperature variaition for the best optimized result
def temperature_variation_with_current(best_circuit_parameters,optimization_input_parameters):
	
	print("----------------------------------Temperature and Current Variation of Best Result ---------------------------------------")
	circuit_parameters=best_circuit_parameters

	Io=circuit_parameters['Ibias']
	
	Io_points_singleside=optimization_input_parameters['temp_cur_side_points']
	a=np.logspace(np.log10(0.1*Io),np.log10(Io),Io_points_singleside+1)
	b=np.logspace(np.log10(Io),np.log10(5*Io),Io_points_singleside+1)
	...
	for i in range(len(Io_list)):
		circuit_parameters['Ibias']=Io_list[i]
...
#-----------------------------------------------------------------------------------------------------
# This function will be used to analyze the temperature variaition for the best optimized result
def temperature_process_variation_final(best_circuit_parameters,optimization_input_parameters):

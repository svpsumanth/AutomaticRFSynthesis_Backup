...
def complete_optimization(optimization_input_parameters):
	...
	best_circuit_parameters=optimization_results['circuit_parameters_iter'][iter_number].copy()
	print("Best Result : ", best_circuit_parameters)
	
	if optimization_input_parameters['temp_var']['run_temp_cur_var']==1:
		tv.temperature_variation_with_current(best_circuit_parameters,optimization_input_parameters)	
	
	if optimization_input_parameters['temp_var']['run_temp_var']==1:
		tv.temperature_variation_final(best_circuit_parameters,optimization_input_parameters)

	if optimization_input_parameters['temp_var']['run_temp_process_var']==1:
		tv.temperature_process_variation_final(best_circuit_parameters,optimization_input_parameters)
...
def single_run(optimization_input_parameters):
	...
	if optimization_input_parameters['temp_var']['run_temp_var']==1:
		tv.temperature_variation_final(circuit_parameters.copy(),optimization_input_parameters)

	if optimization_input_parameters['temp_var']['run_temp_process_var']==1:
		tv.temperature_process_variation_final(circuit_parameters.copy(),optimization_input_parameters)

	if optimization_input_parameters['temp_var']['run_temp_cur_var']==1:
		tv.temperature_variation_with_current(circuit_parameters.copy(),optimization_input_parameters)	
